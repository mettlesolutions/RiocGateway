...
public class RiocTestContainer extends TestContainer {

    public RiocTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/mettles/rioc/app.properties",
    ...
    public static class Common extends RiocTestContainer {

        public static final RiocTestContainer.Common INSTANCE = new RiocTestContainer.Common();
